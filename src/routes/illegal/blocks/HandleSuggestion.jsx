...
export default class HandleSuggestion extends React.Component {
	...
	depositd(){
		...
		this.setState({
			deductScore: {
				smsFlag: 1,
				content: '亲爱的用户您好，您"'+orderDetail.endTime+'"结束使用的小蜜蜂"'+orderDetail.id+'"，违停在"'+detail.content+'"(需停在马路边公共停车区域，严禁停放在小区、胡同、巷道内等非开放区域以及道路上影响交通的地方），因是第{收到违停短信次数}次出现违停本次扣除20元押金，剩余的押金已经原路退回，请您重新缴纳押金使用车辆。请正确停放车辆，方便自己和他人使用。如有问题，您可以拨打客服热线：4000-365-917。'
			}
		})
	}
	//扣积分-双人骑行 扣积分短信模版
	...
	depositsd(){
		...
		this.setState({
			deductScore: {
				smsFlag: 1,
				content: '亲爱的用户您好，因您“'+orderDetail.endTime+'”违规双人行驶小蜜蜂 “'+orderDetail.id+'”，(需单人使用，并且停在马路边公共停车区域，严禁停放在小区、胡同、巷道内等非开放区域以及道路上影响交通的地方）。因是第{收到违停短信次数}次出现违停本次扣除20元押金，剩余的押金已经原路退回，请您重新缴纳押金使用车辆。请正确停放车辆，方便自己和他人使用。如有问题，您可以拨打客服热线：4000-365-917。'
			}
		})
	}
    //扣积分-扣积分短信模版
