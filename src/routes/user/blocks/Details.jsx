	...
	constructor(props) {
		...
		this.state = {
			...
			columns_integral: [
				{title: '编号', data: 'id'},
				{title: '操作时间', data: 'createTime'},
				{title: '操作人', data: 'createName', render:(data) =>(data == '' ?'系统自动':data)},
				...
				<Form horizontal>
					<Row>
						<Col md={5}>
							...
							<Text label="余额" value={(detail.balance || 0) + (detail.grantBalance || 0)}/> <span style={{position: 'absolute', top: 138, left: 180}}>（充值金额{detail.balance || 0}元+赠送金额{detail.grantBalance || 0}元）</span>
